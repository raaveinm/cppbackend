...
public:
    ...
    public:
        ...
        ConnectionWrapper(ConnectionWrapper&& other) noexcept = default;
        ConnectionWrapper& operator=(ConnectionWrapper&& other) noexcept = default;
    ...
    [[nodiscard]] ConnectionWrapper GetConnection() {
